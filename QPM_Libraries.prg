...
// aadd( &( "vLibDefault"+DefineMiniGui3+DefineMinGW+DefineHarbour+Define32bits ), cPre+'hbnulsys'+cExt )   // to avoid "multiple definition" error
...
// aadd( &( "vLibDefault"+DefineMiniGui3+DefineMinGW+DefineHarbour+Define64bits ), cPre+'hbnulsys'+cExt )   // to avoid "multiple definition" error
...
// aadd( &( "vLibDefault"+DefineExtended1+DefineMinGW+DefineHarbour+Define32bits ), cPre+'hbnulsys'+cExt )   // to avoid "multiple definition" error
...
// aadd( &( "vLibDefault"+DefineExtended1+DefineMinGW+DefineXHarbour+Define32bits ), cPre+'hbnulsys'+cExt )   // to avoid "multiple definition" error
...
// aadd( &( "vLibDefault"+DefineExtended1+DefineMinGW+DefineHarbour+Define64bits ), cPre+'hbnulsys'+cExt )   // to avoid "multiple definition" error
...
// aadd( &( "vLibDefault"+DefineExtended1+DefineMinGW+DefineXHarbour+Define64bits ), cPre+'hbnulsys'+cExt )   // to avoid "multiple definition" error
...
// aadd( &( "vLibDefault"+DefineOohg3+DefineMinGW+DefineXHarbour+Define32bits ), cPre+'nulsys'+cExt )   // to avoid "multiple definition" error
   ...
   aadd( &( "vLibDefault"+DefineOohg3+DefineMinGW+DefineHarbour+Define64bits ), cPre+'hbwin'+cExt )
   ...
   aadd( &( "vLibDefault"+DefineOohg3+DefineMinGW+DefineHarbour+Define64bits ), cPre+'xhb'+cExt )
...
// aadd( &( "vLibDefault"+DefineOohg3+DefineMinGW+DefineXHarbour+Define64bits ), cPre+'nulsys'+cExt )   // to avoid "multiple definition" error
