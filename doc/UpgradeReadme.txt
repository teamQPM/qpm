...
[3] If the upgrade contains more files proceed similarly.
...
[1] En la carpeta de instalación actual, renombre el archivo QPM.EXE
    como QPM.EXE.OLD
[2] Copie el nuevo QPM.EXE a la carpeta de instalación actual.
[3] Si el upgrade contiene más archivos proceda en forma similar.
...
[3] Se a atualização contiver mais arquivos, proceda da mesma forma.
